...
local function get_custom_environment(config, context_type)
  if not config or not config.customizations or not config.customizations['devcontainer.nvim'] then
    return {}
  end

  local customizations = config.customizations['devcontainer.nvim']
  local env = {}
...
function M.detect_language(config)
  ...
  if
    ...
    and config.customizations['devcontainer.nvim']
    and config.customizations['devcontainer.nvim'].languagePreset
  then
    return config.customizations['devcontainer.nvim'].languagePreset
  end
...
function M.validate_environment(config)
  ...
  if config.customizations and config.customizations['devcontainer.nvim'] then
    local customizations = config.customizations['devcontainer.nvim']
