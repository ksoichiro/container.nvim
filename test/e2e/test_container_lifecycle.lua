...
-- Container Lifecycle E2E Test for container.nvim
-- Tests the complete lifecycle: ContainerOpen -> ContainerStart -> ContainerStop
...
local function test_container_operations()
  print('=== Container Lifecycle Test: Complete Operations ===')
  ...
  -- Test: Complete lifecycle using plugin
  print('\nTesting complete container lifecycle...')
  ...
  -- Look for lifecycle indicators in output
  local lifecycle_indicators = {
  ...
  if test_passed then
    ...
    print('✓ Plugin successfully executed complete lifecycle operations')
    return true
  else
    print('\n❌ Container lifecycle test FAILED')
    print('❌ No evidence of successful lifecycle operations')
...
-- Run the test
print('Starting container lifecycle E2E test...')
